    ...
    spawnMinions(){
        for(let i=0;i<5;i++){
            ...
            emy.body.velocity.x = Phaser.Math.Between(-500,500);
                ...
                new Bullet(this.myScene,this.x,this.y,0,{anm:'toxicBullet','initSpeed':100});//right
                new Bullet(this.myScene,this.x,this.y,270,{anm:'toxicBullet','initSpeed':100});//up
                new Bullet(this.myScene,this.x,this.y,180,{anm:'toxicBullet','initSpeed':100});//left
